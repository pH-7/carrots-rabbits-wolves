...
class Wolf extends Animal {
  ...
  seekNearbyRabbits() {
    ...
    const nearbyRabbit = this.world.getAnimalByType(LIVING_THINGS.rabbit).reduce(reducer, initialValues)?.rabbit;
    ...
    const hasRabbitBeenEaten = () =>
      nearbyRabbit?.isLiving() && this.world.arePositionsIdentical(this.position, nearbyRabbit.position);
