...
export class Rabbit extends Animal {
  ...
  seekNearbyCarrots() {
    ...
    const nearbyCarrot = this.world.getCarrots().reduce(reducer, initialValues)?.carrot;
    ...
    const hasCarrotBeenEaten = () =>
      nearbyCarrot?.isInStock() && this.world.arePositionsIdentical(this.position, nearbyCarrot.position);
